...
object Token:
  ...
  object Bearer:
    ...
    given keyDecodeBearer[F[_], S](using Reader[F, String], Monad[F]): Decoder[F, Key, Bearer] =
  ...
  given keyDecodeToken[F[_], S](using Reader[F, String], Monad[F]): Decoder[F, Key, auth.Token] =
